...
.new-account
{
  ...
  <body style = "background: url(<?=base_url('assets/landingPage')?>/home.jpg) no-repeat center center fixed;height: 100%;width: 100%; background-position: center; background-repeat: no-repeat; background-size: cover;">
